...
public class EventoShow extends Evento {
    ...
    public EventoShow(Long id, String nome, LocalDateTime data, int capacidadeMaxima, int inscritos, Usuario organizador,
                      String artista, String generoMusical, int duracaoShow, BigDecimal precoIngresso, int idadeMinima,
